...
What does is AKI phenotyping code for?	1
...
What does the Aberdeen AKI phenotyping code do?
...
studyid 		unique id number for each individual
dos 			date of each sample (numerical)
stcreat 		idms aligned serum creatinine (micromol/L)
mdrd 			4 variable MDRD eGFR (ml/min/1.73m2)
